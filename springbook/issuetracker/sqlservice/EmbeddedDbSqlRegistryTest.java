...
public class EmbeddedDbSqlRegistryTest extends AbstractUpdatableSqlRegistryTest{
    ...
    @Test
    public void trasactionalUpdate() {
        /*
        * 초기 상태를 확인한다.
        * 이미 슈퍼클래스의 다른 테스트 메소드에서 확인하긴 했지만 트랜젝션 롤백 후의 결과와 비교돼서
        * 이 테스트의 목적인 롤백 후의 상태는 처음과 동일하다는 것을 비교해서 보여주려고 넣었다.
        * */
        ...
        * 이 때문에 테스트는 실패할 것이고, 그때 과연 롤백이 일어나는지 확인한다.
        * */
        ...
        /*
        * 첫 번째 SQL은 정상적으로 수정했지만 트랜젝션이 롤백되기 때문에 다시 변경 이전 상태로 돌아와야 한다.
        * 트랜젝션이 적용되지 않는다면 변경된 채로 남아서 테스트는 실패할 것이다.
        * */
        checkFindResult("SQL1", "SQL2", "SQL3");
    }
}
